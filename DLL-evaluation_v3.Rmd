...
```{r match-english-words, echo=F, message=F, warning=F}
...
```{r match-spanish-words, echo=F, message=F, warning=F}
...
dll_en_cor = cor(young_en$production, young_en$DLLsum) # .977
...
p3 <- old_en %>% 
  ...
  geom_point(alpha=.1) +  
  xlab("Full CDI Production Score") + ylab("CDI WS Short + DLL2 supplement Score") + 
...
l1_removed <- c("stop", "apple", "shirt", "picture", "give",
                "cheese", "moo", "swing (object)", "ear", "crib",
                "tree", "bite", "quack quack", "go", "baa baa")
l1_added <- c("hurry", "animal", "coffee", "scissors", "show",
              "orange (food)", "brother", "elephant", "day", "food",
              "tummy", "run", "sister", "draw", "school")

# setdiff(l1_removed, dict$english) # shirt
...
l2_removed <- c("nose", "table", "bee", "cup", "picture", "cheese", "soup",
                "knee", "apple", "blanket", "bubbles", "cereal", "soda/pop", 
                "quack quack", "go")
l2_added <- c("food", "closet", "animal", "donkey", "elephant", "wolf", "toy (object)", 
              "pajamas", "shorts", "vagina*", "drawer", "scissors", "brother",
              "sister", "hurry")

# setdiff(l2_removed, dict$english) # bubbles
