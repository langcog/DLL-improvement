...
p3 <- young_en %>%
  ...
  geom_point(alpha=.3) +  
  xlab("Full CDI:WG Production Score") + ylab("CDI WG Short + DLL1 supplement Score") + 
...
p3 <- d_demo_en_comp %>% 
  ...
  geom_point(alpha=.1) +  
  xlab("Full CDI Production Score") + ylab("CDI WG Short + DLL1 supplement Score") + 
...
p3 <- d_demo_sp_comp %>% ggplot(aes(x=comprehension, y=DLL1long_sum, group=sex, color=sex)) + 
  geom_point(alpha=.3) +  
  xlab("Full CDI:WG Comprehension Score") + ylab("CDI WG Short + DLL1 supplement Score") + 
...
cortab <- data.frame(Language = c(rep("English", 3), rep("Spanish", 3)),
                ...
                "r with DLL-ES long" = c(dll1long_en_cor, dll1long_en_cor_comp, dll2long_en_cor,
...
l1_added <- c("draw", "elephant", "animal", "scissors", "brother", "sister", "toothbrush",
