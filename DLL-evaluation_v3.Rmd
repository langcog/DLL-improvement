...
New English DLL1 long supplement vs. full CDI:WG comprehension: $r = `r round(dll1long_new_en_cor_comp, 3)`$. 
...
New Spanish DLL1 long supplement vs. full CDI:WG comprehension: $r = `r round(dll1long_new_sp_cor_comp, 3)`$.
